export default {
    ...
    "Ingka Centres会员可以成为电商平台的代理商": "Members of Ingka Centres can become agents of e-commerce platforms.",
    "通过推荐新会员成为 Ingka Centres 会员和代理商，可以获得价值 00.01%的额外奖金。直接推广会员级别佣金奖励从0.25%起，并投资资本来计算产品代码赚取的利润。": "Members can also become agents of e-commerce platforms by promoting new members and agents. They can earn a 0.01% bonus on referrals and invest capital to calculate the profit from product codes.",
